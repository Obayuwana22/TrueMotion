    ...
    <div className="md:flex md:gap-5 xl:gap-10">
      ...
      >
        <div className="p-4">
          ...
          <Button text="Rental car" className="font-semibold text-xs py-3 px-8 xl:px-5 xl:py-3 xl:mt-2 xl:text-base"/>
      ...
      >
        <div className="p-4">
          ...
          <Button text="Rental car" className="!bg-information-500 font-semibold text-xs py-3 px-8 xl:px-5 xl:py-3 xl:mt-2 xl:text-base"/>
          <div className="mt-5 ml-10 xl:ml-28 xl:mt-0 ">
