...
const CarDetails = () => {
  ...
  return (
    <div className="px-5 mt-10 xl:px-12">
          ...
          <div className="flex justify-between text-xs xl:text-xl">
            <div>
              <div className="flex justify-between mb-5">
                <span className="font-medium text-secondary-300">Type Car</span>
                <span className="font-semibold">{car.carType}</span>
              </div>
              <div className="space-x-8">
                <span className="font-medium text-secondary-300">Steering</span>
            ...
            <div>
              <div className="space-x-8 mb-5">
                <span className="font-medium text-secondary-300">Capacity</span>
                <span className="font-semibold">{car.specs.users.value}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium text-secondary-300">Gasoline</span>
                <span className="font-semibold">{car.specs.fuel.value}</span>
              </div>
            </div>
          </div>
