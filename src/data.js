...
export const userNavbarLinks = [
  {
    ...
    title: "main menu",
    list: [
      { id: nanoid(), icon: RiHome6Line, text: "dashboard", path: "dashboard" },
      { id: nanoid(), icon: IoCarSportOutline, text: "car rent", path: "car-rent" },
      { id: nanoid(), icon: IoStatsChartOutline, text: "insight", path: "insight" },
      { id: nanoid(), icon:  IoWalletOutline, text: "reimburse", path: "reimburse" },
      { id: nanoid(), icon: TbMessageDots, text: "inbox", path: "inbox" },
      { id: nanoid(), icon:  MdOutlineCalendarMonth, text: "calender", path: "calender" },
    ],
  },
  {
    id: nanoid(),
    title: "preferences",
    list: [
      { id: nanoid(), icon: RiSettingsLine, text: "settings", path: "settings" },
      { id: nanoid(), icon: FiHelpCircle, text: "help & center", path: "help-center" },
